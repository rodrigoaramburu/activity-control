    ...
    <script defer>
        document.addEventListener("DOMContentLoaded", function(event) {
            ...
            const myChart = new Chart(ctx, {
                ...
                title: {
                    display: true,
                    text: 'Número de Horas por Actividade'
                }
            }
                }
            });
            Livewire.on('chartChange',function(activitiesPerHour){
                console.log(activitiesPerHour);
                myChart.data.datasets[0].data = activitiesPerHour ;
                myChart.update();
            });
        });

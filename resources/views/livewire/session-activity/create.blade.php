<div>
    ...
    <div>
        <button wire:click="openCreate" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full my-2">
            Nova Sessão
        </button>

        <button wire:click="openCronometer" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full my-2">
            Iniciar Crônometro
        </button>
    </div>
